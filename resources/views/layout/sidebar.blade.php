                ...
                <div class="nav-buttons">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{request()->routeIs('records') ? 'active' : ''}}" id="currentweek-tab">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{request()->routeIs('targets') ? 'active' : ''}}" id="weekly-tab">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{request()->routeIs('monthly') ? 'active' : ''}}" id="monthly-tab" >
