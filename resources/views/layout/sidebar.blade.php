            ...
            <div class="offcanvasnav">
                <div class="nav-buttons">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        @canany('Record access', 'Record create', 'Record edit', 'Record delete')
                            <li class="nav-item" role="presentation">
                                <button
                                    class="nav-link
                                {{ request()->routeIs('records') ? 'active' : '' }}
                                {{ request()->routeIs('create-record') ? 'active' : '' }}
                                {{ request()->routeIs('edit-record') ? 'active' : '' }}
                                "
                                    id="currentweek-tab">
                        ...
                        @endcanany
                        @canany('Target access', 'Target edit')
                            <li class="nav-item" role="presentation">
                                <button
                                    class="nav-link
                            {{ request()->routeIs('targets') ? 'active' : '' }}
                            {{ request()->routeIs('update-target') ? 'active' : '' }}
                                "
                                    id="weekly-tab">
                        ...
                        @endcanany
                        @canany('Weekly access', 'Weekly export')
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ request()->routeIs('weekly') ? 'active' : '' }}" id="weekly-tab">
                                    <a href="{{ route('weekly') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 16 16" fill="none">
                                            <g clip-path="url(#clip0_31_45)">
                        ...
                        @endcanany
                        @canany('Monthly access', 'Monthly export')
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ request()->routeIs('monthly') ? 'active' : '' }}"
                                    id="monthly-tab">
                                    <a href="{{ route('monthly') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 16 16" fill="none">
                        ...
                        @canany('Permission access', 'Permission create', 'Permission edit', 'Permission delete')
                            <li class="nav-item" role="presentation">
                                <button
                                    class="nav-link
                                {{ request()->routeIs('permission.index') ? 'active' : '' }}
                                {{ request()->routeIs('permission.create') ? 'active' : '' }}
                                {{ request()->routeIs('permission.edit') ? 'active' : '' }}
                                    "
                                    id="settings-tab">
                        ...
                        @canany('Role access', 'Role create', 'Role edit', 'Role delete')
                            <li class="nav-item" role="presentation">
                                <button
                                    class="nav-link
                                {{ request()->routeIs('role.index') ? 'active' : '' }}
