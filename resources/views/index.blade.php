                                ...
                                <button class="nav-link active" id="currentweek-tab" data-bs-toggle="tab" data-bs-target="#currentweek" type="button" role="tab" aria-controls="home" aria-selected="true">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                        <g clip-path="url(#clip0_31_38)">
                                          ...
                                          <path d="M13.3334 0H11.3334C9.86066 0 8.66675 1.19391 8.66675 2.66667V4.66667C8.66675 6.13943 9.86066 7.33333 11.3334 7.33333H13.3334C14.8062 7.33333 16.0001 6.13943 16.0001 4.66667V2.66667C16.0001 1.19391 14.8062 0 13.3334 0Z" fill="#42526E" fill-opacity="0.5"/>
                                          <path d="M4.66667 8.6665H2.66667C1.19391 8.6665 0 9.86041 0 11.3332V13.3332C0 14.8059 1.19391 15.9998 2.66667 15.9998H4.66667C6.13943 15.9998 7.33333 14.8059 7.33333 13.3332V11.3332C7.33333 9.86041 6.13943 8.6665 4.66667 8.6665Z" fill="#42526E" fill-opacity="0.5"/>
                                          <path d="M13.3334 8.6665H11.3334C9.86066 8.6665 8.66675 9.86041 8.66675 11.3332V13.3332C8.66675 14.8059 9.86066 15.9998 11.3334 15.9998H13.3334C14.8062 15.9998 16.0001 14.8059 16.0001 13.3332V11.3332C16.0001 9.86041 14.8062 8.6665 13.3334 8.6665Z" fill="#42526E" fill-opacity="0.5"/>
                                        </g>
                                        <defs>
                                ...
                                <button class="nav-link" id="link-tab" data-bs-toggle="tab" data-bs-target="#link" type="button" role="tab">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <g clip-path="url(#clip0_41_60)">
                                      <path d="M0.961029 15.039C2.2424 16.3205 4.32004 16.3205 5.60141 15.039L9.21725 11.4232C7.94003 11.5714 7.16989 11.1409 6.91245 11.0764L4.2756 13.7132C3.72726 14.2615 2.83517 14.2615 2.28683 13.7132C1.73849 13.165 1.73849 12.2728 2.28683 11.7246C2.38803 11.6232 6.5527 7.45857 6.42111 7.59029C6.95602 7.05526 7.86105 7.04158 8.40976 7.59029C8.45419 7.63472 8.48764 7.68514 8.52475 7.7336C8.7225 7.71468 8.91122 7.75179 9.07272 7.59029L10.0276 6.63546C9.93503 6.50911 9.84995 6.37887 9.73557 6.26449C8.46457 4.99337 6.34116 5.01852 5.09518 6.26449L0.961029 10.3986C-0.320343 11.68 -0.320343 13.7576 0.961029 15.039Z" fill="#42526E" fill-opacity="0.5"/>
                                      <path d="M15.0389 0.961026C13.7576 -0.320342 11.6799 -0.320342 10.3986 0.961026L6.93945 4.42012C8.21667 4.27193 8.98682 4.70247 9.24426 4.76692L11.7245 2.28683C12.2728 1.73849 13.1648 1.73849 13.7131 2.28683C14.2615 2.83517 14.2615 3.72725 13.7131 4.27559L10.4982 7.49055L9.7356 8.253C9.20068 8.78815 8.29565 8.80182 7.74695 8.253C7.70251 8.20869 7.66907 8.15827 7.63196 8.10981C7.4342 8.12873 7.24548 8.0915 7.08398 8.253L6.12915 9.20783C6.22168 9.33417 6.30676 9.46454 6.42114 9.57892C7.69214 10.85 9.81555 10.8248 11.0615 9.57892L15.0389 5.60139C16.3203 4.32002 16.3203 2.24239 15.0389 0.961026Z" fill="#42526E" fill-opacity="0.5"/>
                                    </g>
                                    <defs>
                ...
                <form action="">
                  ...
                  <div class="row mainRow">
                    ...
                    <div class="col">
                      <div class="row">
                        <div class="col-2 label">
                          <label for="phone" class="form-label" aria-required="true">Phone No.</label>
                        </div>
                        <div class="col input">
